...
@php
    ...
    $variants = [
        ...
        'navy'      => 'bg-navy-900 text-white hover:bg-navy-700 hover:-translate-y-px focus-visible:outline-navy-900',
        ...
        'white'     => 'bg-white text-navy-900 hover:bg-brand-50 hover:-translate-y-px shadow-soft focus-visible:outline-white',
    ];
