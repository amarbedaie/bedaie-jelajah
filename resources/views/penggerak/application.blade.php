<x-layouts.app :title="'Permohonan '.$application->reference_no" nav="penggerak">
    ...
    <div class="mt-4 flex flex-wrap items-start justify-between gap-4">
        <div class="min-w-0">
            <h1 class="font-display text-2xl text-navy-900 sm:text-3xl text-pretty">{{ $application->venue_name }}</h1>
    ...
    <div class="mt-7 grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
        <div class="space-y-6">
            {{-- Status semasa --}}
            <x-ui.card>
                <h2 class="font-semibold text-navy-900">Status Permohonan</h2>
                <div class="mt-4">
            ...
            <x-ui.card>
                <h2 class="font-semibold text-navy-900">Perjalanan Permohonan</h2>
            ...
            {{-- Maklumat dihantar --}}
            <x-ui.card>
                <h2 class="font-semibold text-navy-900">Maklumat Yang Anda Hantar</h2>
        ...
        <aside class="space-y-5">
            <x-ui.card>
                <h3 class="font-semibold text-navy-900">Perlukan Bantuan?</h3>
