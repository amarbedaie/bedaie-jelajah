...
<body class="bg-mist antialiased">
    ...
    <div class="py-8">
        ...
        <div class="poster mx-auto flex aspect-[1/1.414] w-full max-w-[46rem] flex-col overflow-hidden
                    bg-navy-900 shadow-lift">
            <div class="relative flex flex-1 flex-col">
                <div class="motif-girih-dark absolute inset-0 opacity-70" aria-hidden="true"></div>
                <div class="absolute -right-20 -top-24 h-80 w-80 rounded-full bg-brand-500/30 blur-3xl" aria-hidden="true"></div>
                ...
                <div class="relative flex flex-1 flex-col p-10">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <span class="rounded-full bg-white/10 px-3.5 py-1.5 text-[0.65rem] font-semibold
                                     uppercase tracking-[0.18em] text-brand-300 ring-1 ring-white/15">
                    ...
                    <div class="mt-12 flex-1">
                        <p class="text-sm font-semibold uppercase tracking-[0.22em] text-brand-300">
                        ...
                        @if ($event->theme)
                            <p class="mt-4 text-xl text-brand-200 text-pretty">{{ $event->theme }}</p>
                        @endif

                        @if ($event->speaker)
                            <div class="mt-8 inline-flex items-center gap-3 rounded-2xl bg-white/8 px-5 py-3
                                        ring-1 ring-white/12">
                                <x-ui.icon name="user" class="h-5 w-5 text-brand-300" />
                                <div>
                        ...
                        <dl class="mt-10 space-y-4">
                            <div class="flex items-start gap-4">
                                ...
                                <x-ui.icon name="calendar" class="mt-1 h-6 w-6 shrink-0 text-brand-300" />
                                <dd>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <x-ui.icon name="pin" class="mt-1 h-6 w-6 shrink-0 text-brand-300" />
                                <dd>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <x-ui.icon name="ticket" class="mt-1 h-6 w-6 shrink-0 text-brand-300" />
                                <dd>
