<div class="flex flex-col items-end gap-2">
    ...
    @elseif ($mode === 'regenerate')
        <div class="w-full max-w-sm rounded-xl border border-clay-200 bg-clay-50/60 p-3 text-left">
            ...
            <div class="mt-2.5">
                <label for="cn-{{ $certificate->id }}" class="sr-only">Nama yang dibetulkan</label>
    ...
    @elseif ($mode === 'revoke')
        <div class="w-full max-w-sm rounded-xl border border-danger/30 bg-danger-soft p-3 text-left">
            ...
            <div class="mt-2.5">
                <label for="cr-{{ $certificate->id }}" class="sr-only">Sebab pembatalan</label>
                <x-ui.input id="cr-{{ $certificate->id }}" wire:model="revokeReason"
