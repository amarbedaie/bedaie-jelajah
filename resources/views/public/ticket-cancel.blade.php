            ...
            <x-ui.card class="sm:p-8">
                <div class="text-center">
                    ...
                    <p class="mt-3 text-ink-soft text-pretty">
                        ...
                        <strong class="text-ink">{{ $registration->event->title }}</strong>
                ...
                <div class="mt-6 rounded-xl bg-mist p-4 text-sm">
                    <div class="flex justify-between gap-3">
                        ...
                        <span class="font-mono text-ink">{{ $registration->reference_no }}</span>
                    </div>
                    <div class="mt-2 flex justify-between gap-3">
                        <span class="text-ink-muted">Nama</span>
                        <span class="text-ink">{{ $registration->name }}</span>
                    </div>
                    <div class="mt-2 flex justify-between gap-3">
                        <span class="text-ink-muted">Tempat</span>
                        <span class="text-ink">{{ $registration->seats() }}</span>
                    </div>
                </div>
